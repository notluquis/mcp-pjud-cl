...
mentira.** La línea base del 24 de agosto de 2026 son 4.197 mutantes con 3.110 muertos: una
...
- `mutmut` corre cada mutante en un hijo por `fork()`, y `httpx.Client()` pregunta por el proxy
  ...
  el 24 de agosto de 2026 eso convirtió 2.071 mutantes en `💥`, o sea la mitad de aquella
  medición era del corredor. `tests/conftest.py` pone una variable `*_proxy` para que
  `getproxies()` responda
