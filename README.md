...
[![tests](https://github.com/notluquis/mcp-pjud/actions/workflows/tests.yml/badge.svg)](https://github.com/notluquis/mcp-pjud/actions/workflows/tests.yml)
[![docs](https://readthedocs.org/projects/mcp-pjud/badge/?version=latest)](https://mcp-pjud.readthedocs.io)
...
Se pide [abriendo un issue](https://github.com/notluquis/mcp-pjud/issues/new/choose) con la
...
[mcp-pjud.readthedocs.io](https://mcp-pjud.readthedocs.io), con dos entradas separadas:

- **[Para abogados](https://mcp-pjud.readthedocs.io/es/latest/para-abogados.html)** — qué
  resuelve, cómo leer los resultados, qué no hace. Sin código.
- **[Para informática](https://mcp-pjud.readthedocs.io/es/latest/para-informatica.html)** —
  instalación, arquitectura, controles de uso responsable.

Además: [referencia de herramientas](https://mcp-pjud.readthedocs.io/es/latest/herramientas.html),
[cumplimiento](https://mcp-pjud.readthedocs.io/es/latest/cumplimiento.html) y
[hoja de ruta](https://mcp-pjud.readthedocs.io/es/latest/roadmap.html).
...
[cumplimiento](https://mcp-pjud.readthedocs.io/es/latest/cumplimiento.html).
