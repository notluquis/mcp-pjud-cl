...
```
User-Agent: mcp-pjud/0.10.0 (+contacto: informatica@estudio.cl)
```
...
| `@v0.10.0` | Esa versión y ninguna otra | Cuando el entorno exige que nada cambie sin revisión |
...
```
"args": ["--from", "git+https://github.com/notluquis/mcp-pjud-cl@v0.10.0", "mcp-pjud"]
```
