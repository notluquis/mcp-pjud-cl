...
```bash
git clone https://github.com/notluquis/mcp-pjud
cd mcp-pjud
uv sync
```
...
Tres módulos, unas 630 líneas de código.
...
Se pide [abriendo un issue](https://github.com/notluquis/mcp-pjud/issues/new/choose), se
