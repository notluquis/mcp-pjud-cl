...
`buscar_jurisprudencia` anda contra cuatro de los diez buscadores: Corte Suprema, Cortes de
Apelaciones, Laborales y Civiles. Con la paginación medida, una búsqueda ya no se corta en la coincidencia
