...
| Cuánto dura `documento_referencia` | los otros dos tokens se leyeron de su JWT: el del listado declara media hora y el del cuaderno una hora. Éste no se midió |
